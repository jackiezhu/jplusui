...
var UI = {
    ...
    _showRefreshButton: function () {
        ...
        toolbar.href = Demo.Configs.serverBaseUrl + Demo.Configs.apps + '/modulemanager/server/api.njs?action=updatelist&postback=' + encodeURIComponent(location.href);
