...
ModuleBuilder.start = ModuleBuilder.complete = function() {};
    ...
    fileTypes: {
        ...
        '.html': {
            ...
            process: function (options, fromPath, toPath, fromName, toName) {
                            ...
                            if (attrs.src && /boot\.js(\?|#|$)/.test(attrs.src)) {
                                ...
                                if (params) {
                                    ...
                                    if (result.outputCssCode != null) {
                                        all += '<link rel="stylesheet" type="text/css" href="' + buildPath + '.js">';
                                    }
                                    ...
                                    if (result.outputJsCode != null) {
                                        ...
                                        all += '<script type="text/javascript" src="' + buildPath + '.css"></script>';
                                    }
                ...
                var versionPostfix = this.appendVersionPostfix && options.versionPostfix || (options.versionPostfix = '_=' + Utility.getNow().replace(/\D/g, ""));
